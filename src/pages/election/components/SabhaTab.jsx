...
export default function SabhaTab() {
  return (
      ...
      <div className="max-w-md text-center space-y-6 z-10 flex flex-col items-center">
        ...
        <div className="space-y-2">
          <h2 className="text-xl font-extrabold text-slate-800 tracking-tight">
            Sabha & Public Meeting Planner
          </h2>
          <p className="text-sm text-slate-500 leading-relaxed">
            Organize public assemblies, coordinate speaker lineups, request official administration permissions, and track crowd safety logistics seamlessly.
          </p>
        </div>
        ...
        <div className="w-full bg-slate-50 rounded-xl p-4 border border-slate-100 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 text-left">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-slate-700">Phase 4 • Q4 2026</p>
            </div>
          </div>
