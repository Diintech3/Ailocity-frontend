...
import { api, TOKEN_ADMIN } from '../../lib/api'
      ...
      <div className="w-full max-w-sm">
        <div className="bg-white border border-slate-200 rounded-2xl p-7 shadow-md">
          <div className="mb-6 text-center">
            <h1 className="text-slate-900 text-xl font-bold">Admin Login</h1>
            <p className="text-slate-500 text-sm mt-1">Manage your apps & clients</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className={inputCls}
                placeholder="admin@ailocity.com"
                required
              />
            </div>
